...
Route::get('/', 'LandingController@index'); // for guest 
Route::get('/home', 'HomeController@index')->middleware(['web','auth']);  // for user 
Route::get('/admin-panel', 'AdminController@index')->middleware(['web','auth']);  // for admin
